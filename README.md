...
This project has some limitations and areas for improvement that I plan to work on in the future. These include:

- **Collecting more data** for testing and validation purposes. Currently, there is no separate test set to evaluate the performance of the model on unseen data.
- **Using image-processing and computer vision techniques** to augment the existing data and generate more samples. This can help overcome the problem of data scarcity and improve the generalization ability of the model.
